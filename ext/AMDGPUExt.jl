...
OMEinsum._reshape(x::ROCArray, sz) = reshape(x, sz)
OMEinsum._reshape(x::Adjoint{T,<:ROCArray{T}} where {T}, sz) = reshape(ROCArray(x), sz)
OMEinsum._reshape(x::Transpose{T,<:ROCArray{T}} where {T}, sz) = reshape(ROCArray(x), sz)
